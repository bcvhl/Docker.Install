...
#######################################################
    ...
    sudo docker network create vhl-network
    sleep 2s
    ...
    echo "All docker applications have been added to the docker network vhl-network"
    echo ""
    echo "If you add more docker applications to this server, make sure to add them to the vhl-network network."
